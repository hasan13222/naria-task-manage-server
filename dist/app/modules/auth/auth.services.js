...
const changeUserPasswordIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcrypt_1.default.hash(payload.newPassword, Number(config_1.default.salt));
    const result = yield auth_model_1.User.findByIdAndUpdate(user._id, {
...
const sendLinkToEmail = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resetLink = `${config_1.default.client_url}/reset-password?id=${user._id}&token=${accessToken}`;
...
const setForgottenPasswordIntoDB = (useremail, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const user = yield auth_model_1.User.findOne({ email: useremail }).select("+password");
    console.log(user);
    if (!user) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.NOT_FOUND, "User not found");
    }
...
const createUserIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const hashedPassword = yield bcrypt_1.default.hash(newUser.password, Number(config_1.default.salt));
    newUser.password = hashedPassword;
    const result = yield auth_model_1.User.create(newUser);
    return result;
});
...
const loginAuth = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const refreshToken = jsonwebtoken_1.default.sign(jwtPayload, config_1.default.refresh_token_secret, { expiresIn: "90d" });
